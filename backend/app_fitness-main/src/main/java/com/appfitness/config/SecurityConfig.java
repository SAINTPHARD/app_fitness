...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(
        ...
        return http
                ...
                .authorizeHttpRequests(authorize -> authorize
                        ...
                        .requestMatchers(HttpMethod.POST, "/auth/login", "/auth/refresh", "/login", "/usuarios").permitAll()
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        if (origins.isEmpty()) {
            throw new IllegalStateException("app.cors.allowed-origins deve conter ao menos uma origem permitida");
        }
